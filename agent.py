...
class Agent():
    ...
    def mdp(self, state, TRIGAR, action,     states_known, map, grid, DIR,     VIZL, VIZD):
        self.TRIGAR_advance = TRIGAR
        self.VIZL = VIZL
        self.VIZD = VIZD
        ...
        if self.NODELIST[state.row][state.column] in pre or self.NODELIST[state.row][state.column] == "x":
            ...
            test.show(aaa, v, state, m, DIR,     self.VIZL, self.VIZD)
            # test.show_values(a)
    ...
    def mdp_exp(self, state, TRIGAR,     states_known, map, grid, DIR,     VIZL, VIZD):
        self.TRIGAR_advance = TRIGAR
        self.VIZL = VIZL
        self.VIZD = VIZD
